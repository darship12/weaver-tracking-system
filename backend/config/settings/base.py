...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-weaver-tracking-secret-key-change-in-production')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Weaver Tracking System API',
    'DESCRIPTION': 'Production-level weaver employee tracking system',
    'VERSION': '1.0.0',
}
